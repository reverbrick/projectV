            ...
            if b.pixels() > min_area and b.pixels() < max_area:
                ...
                if sum(pix) >=0 and sum(pix) <= 8:
                    ...
                    if (major_len > 385 and major_len < 410) and (ratio_minor > 7 and ratio_minor < 10):
                        ...
                        if roi1[0] < 1275 and roi2[0] < 1275 and roi3[0] < 1275 and roi4[0] < 1275 and roi5[0] < 1275 and roi6[0] < 1275:
                            if roi1[1] < 1020 and roi2[1] < 1020 and roi3[1] < 1020 and roi4[1] < 1020 and roi5[1] < 1020 and roi6[1] < 1020:
